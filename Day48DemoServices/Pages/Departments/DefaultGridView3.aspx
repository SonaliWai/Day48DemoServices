<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultGridView3.aspx.cs" Inherits="Day48DemoServices.Pages.Departments.DefaultGridView3" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Department - GridView 3</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
                ...
                <Columns>
                    <asp:TemplateField ShowHeader="False">
                        <EditItemTemplate>
                            ...
                            &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Cancel1" Text="Cancel1"></asp:LinkButton>
                        </EditItemTemplate>
                        <ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                               ...
                               DeleteCommand="Delete Depertment where Id = @id"
                               InsertCommand="Insert into Depertment(Name,Description)values (@Name,@Description)">
                <UpdateParameters>
